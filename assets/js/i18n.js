...
window.SITE_I18N = {
  ...
  en: {
    ...
    weeklySection: {
      ...
      soups: "Soups", mains: "Main Dishes", desserts: "Desserts", bread: "Bread", combo: "Daily Package Menu",
  ...
  tr: {
    ...
    weeklySection: {
      ...
      soups: "Çorbalar", mains: "Ana Yemekler", desserts: "Tatlılar", bread: "Ekmek", combo: "Günün Paket Menüsü",
  ...
  ar: {
    ...
    weeklySection: {
      ...
      soups: "الشوربات", mains: "الأطباق الرئيسية", desserts: "الحلويات", bread: "الخبز", combo: "قائمة الوجبة الكاملة لليوم",
...
window.WEEKLY_MENU = {
  ...
  data: {
    mon: {
      soups: [
        { name: { bg: "Телешко варено", en: "Boiled Beef Soup (Teleshko Vareno)", tr: "Dana Eti Çorbası (Teleshko Vareno)", ar: "شوربة لحم العجل المسلوق" }, price: 2.30 },
      ...
      mains: [
        { name: { bg: "Пил. месо със сметана, гъби и броколи", en: "Chicken in Cream Sauce with Mushrooms & Broccoli", tr: "Kremalı, Mantarlı ve Brokolili Tavuk", ar: "دجاج بصلصة الكريمة مع الفطر والبروكلي" }, price: 5.50 },
        { name: { bg: "Пил. роле с кашкавал + гарнитура", en: "Chicken Roll with Kashkaval + Side", tr: "Kaşkavallı Tavuk Rulo + Garnitür", ar: "رول دجاج بجبنة الكشكافال + طبق جانبي" }, price: 4.50 },
        { name: { bg: "2бр. телешки кюфтета + разядка с маслини и разядка с патладжан", en: "2 pcs Beef Meatballs + Olive Spread & Aubergine Spread", tr: "2 adet Dana Köfte + Zeytin Ezmesi ve Patlıcan Ezmesi", ar: "قطعتان كفتة لحم بقري + غموس الزيتون وغموس الباذنجان" }, price: 5.50 },
      ...
      combo: { name: { bg: "Леща + 2бр. Пържени кюфтета с гарн. + Крем карамел", en: "Lentil Stew + 2 pcs Fried Meatballs with Side + Crème Caramel", tr: "Mercimek + 2 adet Kızarmış Köfte Garnitürlü + Karamelli Muhallebi", ar: "عدس + قطعتان كفتة مقلية مع طبق جانبي + كريم كراميل" }, price: 7.90 }
    },
    tue: {
      soups: [
      ...
      mains: [
        { name: { bg: "Боб яхния + 2бр. кюфтета", en: "Bean Stew + 2 pcs Meatballs", tr: "Fasulye Yahnisi + 2 adet Köfte", ar: "يخنة الفاصولياء + قطعتان كفتة" }, price: 4.50 },
        { name: { bg: "Свински шиш + гарнитура", en: "Pork Skewer + Side", tr: "Domuz Şiş + Garnitür", ar: "أسياخ لحم خنزير + طبق جانبي" }, price: 4.50 },
        { name: { bg: "Татарско кюфте + карт. соте", en: "Tatar-Style Meatball + Sautéed Potatoes", tr: "Tatar Köftesi + Sote Patates", ar: "كفتة تتارية + بطاطس ساوتيه" }, price: 4.50 },
        { name: { bg: "3бр. Панирани чушки + плочка сирене", en: "3 pcs Breaded Peppers + Slice of Cheese", tr: "3 adet Panelenmiş Biber + Dilim Peynir", ar: "3 حبات فلفل مقلي + شريحة جبنة" }, price: 4.00 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
        { name: { bg: "Макарони на фурна", en: "Baked Sweet Macaroni", tr: "Fırında Makarna (Tatlı)", ar: "معكرونة بالفرن (حلوة)" }, price: 2.30 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 },
      combo: { name: { bg: "Таратор + Кюфтета с доматен сос + Макарони на фурна", en: "Tarator + Meatballs in Tomato Sauce + Baked Sweet Macaroni", tr: "Tarator + Domates Soslu Köfte + Fırında Makarna", ar: "طاراتور + كفتة بصلصة الطماطم + معكرونة بالفرن" }, price: 7.90 }
    },
    wed: {
      soups: [
      ...
      mains: [
        { name: { bg: "Свинско със спанак и ориз", en: "Pork with Spinach & Rice", tr: "Ispanaklı ve Pirinçli Domuz Eti", ar: "لحم خنزير بالسبانخ والأرز" }, price: 4.50 },
        { name: { bg: "Пилешки шиш + боб с лютеница + гарнитура", en: "Chicken Skewer + Beans with Lyutenitsa + Side", tr: "Tavuk Şiş + Lyutenitsalı Fasulye + Garnitür", ar: "أسياخ دجاج + فاصولياء بالليوتينيتسا + طبق جانبي" }, price: 4.50 },
        { name: { bg: "Кюфтета по Цариградски", en: "Tsarigrad-Style Meatballs", tr: "İstanbul Usulü Köfte", ar: "كفتة على الطريقة القسطنطينية" }, price: 4.50 },
        { name: { bg: "3бр. Тиквени кюфтета + Снежанка", en: "3 pcs Pumpkin Fritters + Snezhanka Salad", tr: "3 adet Kabak Köftesi + Snejanka Salatası", ar: "3 كفتات يقطين + سلطة سنيجانكا" }, price: 4.50 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
        { name: { bg: "Дамски каприз", en: "Damski Kapriz (Layered Cream Dessert)", tr: "Damski Kapriz (Katmanlı Kremalı Tatlı)", ar: "دامسكي كابريز (حلوى كريمة بطبقات)" }, price: 2.30 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 },
      combo: { name: { bg: "Пилешка супа + 2бр. Кебапче с г-ра + Дамски каприз", en: "Chicken Soup + 2 pcs Kebapche with Side + Damski Kapriz", tr: "Tavuk Çorbası + 2 adet Kebapçe Garnitürlü + Damski Kapriz", ar: "شوربة دجاج + قطعتان كبابتشي مع طبق جانبي + دامسكي كابريز" }, price: 7.90 }
    },
    thu: {
      soups: [
      ...
      mains: [
        { name: { bg: "Винен кебап + топка ориз", en: "Wine Kebab + Rice Ball", tr: "Şaraplı Kebap + Pirinç Topu", ar: "كباب بالنبيذ + كرة أرز" }, price: 4.50 },
        ...
        { name: { bg: "Огретен", en: "Gratin", tr: "Graten", ar: "غراتان" }, price: 4.50 },
    ...
    fri: {
      soups: [
        { name: { bg: "Боб чорба", en: "Bean Soup", tr: "Fasulye Çorbası", ar: "شوربة الفاصولياء" }, price: 2.30 },
        { name: { bg: "Шкембе чорба", en: "Tripe Soup (Shkembe Chorba)", tr: "İşkembe Çorbası", ar: "شوربة الكرشة" }, price: 2.30 },
        { name: { bg: "Таратор", en: "Tarator (Cold Cucumber-Yogurt Soup)", tr: "Tarator (Soğuk Yoğurt Çorbası)", ar: "طاراتور (شوربة زبادي باردة)" }, price: 2.00 }
      ],
      mains: [
        { name: { bg: "Пан. бяла риба + картофи соте", en: "Breaded White Fish + Sautéed Potatoes", tr: "Panelenmiş Beyaz Balık + Sote Patates", ar: "سمك أبيض مقلي بالبقسماط + بطاطس ساوتيه" }, price: 4.80 },
        { name: { bg: "Свинска пържола + г-ра", en: "Pork Chop + Side", tr: "Domuz Pirzola + Garnitür", ar: "شريحة لحم خنزير + طبق جانبي" }, price: 5.50 },
        { name: { bg: "3бр. Картофени кюфтета + г-ра", en: "3 pcs Potato Fritters + Side", tr: "3 adet Patates Köftesi + Garnitür", ar: "3 كفتات بطاطس + طبق جانبي" }, price: 4.50 },
        { name: { bg: "Гювеч със свински джолан", en: "Guvech with Pork Shank", tr: "Domuz İncikli Güveç", ar: "يخنة بساق الخنزير في الفخار" }, price: 4.50 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
        { name: { bg: "Мляко с ориз", en: "Rice Pudding", tr: "Sütlaç", ar: "أرز باللبن" }, price: 2.30 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 },
      combo: { name: { bg: "Зеленчукова крем супа със сирене и крутони + Гювеч със св. джолан + Крем Карамел", en: "Cream of Vegetable Soup with Cheese & Croutons + Guvech with Pork Shank + Crème Caramel", tr: "Kremalı Sebze Çorbası (Peynir ve Kruton ile) + Domuz İncikli Güveç + Karamelli Muhallebi", ar: "شوربة خضار كريمية بالجبنة والخبز المحمص + يخنة بساق الخنزير + كريم كراميل" }, price: 7.90 }
    }
  }
};
