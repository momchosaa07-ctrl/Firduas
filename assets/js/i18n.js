...
window.WEEKLY_MENU = {
  ...
  data: {
    mon: {
      ...
      mains: [
        { name: { bg: "Боб със свинско месо", en: "Beans with Pork", tr: "Domuz Etli Fasulye", ar: "فاصولياء بلحم الخنزير" }, price: 4.50 },
        { name: { bg: "Пан. пил. бонфиленца с корнфл. + гарнитура", en: "Breaded Chicken Fillet in Cornflakes + Side", tr: "Mısır Gevreği Kaplı Tavuk Fileto + Garnitür", ar: "فيليه دجاج مقرمش بالكورن فليكس + طبق جانبي" }, price: 5.80 },
      ...
      desserts: [
        ...
        { name: { bg: "Сметанов крем с плодове и ядки", en: "Cream Dessert with Fruit & Nuts", tr: "Meyveli ve Kuruyemişli Krema", ar: "كريمة بالفواكه والمكسرات" }, price: 3.00 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 }
    },
    tue: {
      soups: [
        { name: { bg: "Крем супа от червена леща + сирене и крутони", en: "Red Lentil Cream Soup with Cheese & Croutons", tr: "Kırmızı Mercimek Çorbası (Peynir ve Kruton ile)", ar: "شوربة عدس أحمر كريمية بالجبنة والخبز المحمص" }, price: 2.30 },
        { name: { bg: "Шкембе чорба", en: "Tripe Soup (Shkembe Chorba)", tr: "İşkembe Çorbası", ar: "شوربة الكرشة" }, price: 2.30 },
        { name: { bg: "Таратор", en: "Tarator (Cold Cucumber-Yogurt Soup)", tr: "Tarator (Soğuk Yoğurt Çorbası)", ar: "طاراتور (شوربة زبادي باردة)" }, price: 2.00 }
      ],
      mains: [
        { name: { bg: "Свинско със зеле", en: "Pork with Cabbage", tr: "Lahanalı Domuz Eti", ar: "لحم خنزير بالملفوف" }, price: 4.50 },
        { name: { bg: "Пилешка кавърма", en: "Chicken Kavarma (Stew)", tr: "Tavuk Kavurma", ar: "كفارما دجاج" }, price: 4.50 },
        { name: { bg: "Омлет със сирене + гарнитура домати и краставици", en: "Cheese Omelette + Tomato & Cucumber Side", tr: "Peynirli Omlet + Domates Salatalık Garnitürü", ar: "أومليت بالجبنة + طماطم وخيار" }, price: 4.00 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
        { name: { bg: "2бр. Палачинки със сладко или шоколад", en: "2 pcs Pancakes with Jam or Chocolate", tr: "2 adet Reçelli veya Çikolatalı Krep", ar: "2 فطيرة بالمربى أو الشوكولاتة" }, price: 2.30 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 }
    },
    wed: {
      ...
      mains: [
        { name: { bg: "Гювеч с пилешко месо", en: "Chicken Guvech (Clay Pot Stew)", tr: "Tavuklu Güveç", ar: "يخنة الدجاج في الفخار" }, price: 4.50 },
        { name: { bg: "Шницел Миланезе + гарн.", en: "Schnitzel Milanese + Side", tr: "Şnitzel Milanez + Garnitür", ar: "شنيتزل ميلانيز + طبق جانبي" }, price: 5.50 },
        { name: { bg: "Миш-маш", en: "Mish-Mash (Egg & Vegetable Scramble)", tr: "Miş-Maş (Sebzeli Yumurta)", ar: "ميش ماش (بيض بالخضار)" }, price: 4.00 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
        { name: { bg: "Домашен чийзкейк", en: "Homemade Cheesecake", tr: "Ev Yapımı Cheesecake", ar: "تشيز كيك منزلي" }, price: 3.00 }
      ],
      bread: { name: { bg: "Домашна питка", en: "Homemade Bread", tr: "Ev Yapımı Ekmek", ar: "خبز منزلي" }, price: 0.70 }
    },
    thu: {
      ...
      mains: [
        { name: { bg: "Пил. бутчета с ориз и зеленчуци", en: "Chicken Drumsticks with Rice & Vegetables", tr: "Pirinç ve Sebzeli Tavuk But", ar: "أفخاذ دجاج مع الأرز والخضار" }, price: 4.50 },
        { name: { bg: "Шницел от кайма + гарнитура", en: "Minced Meat Schnitzel + Side", tr: "Kıyma Şnitzel + Garnitür", ar: "شنيتزل لحم مفروم + طبق جانبي" }, price: 4.50 },
        { name: { bg: "3бр. Панирани чушки + гарн.", en: "3 pcs Breaded Peppers + Side", tr: "3 adet Panelenmiş Biber + Garnitür", ar: "3 حبات فلفل مقلي + طبق جانبي" }, price: 4.50 }
      ],
      desserts: [
        { name: { bg: "Крем карамел", en: "Crème Caramel", tr: "Karamelli Muhallebi", ar: "كريم كراميل" }, price: 2.30 },
        { name: { bg: "Плодова салата", en: "Fruit Salad", tr: "Meyve Salatası", ar: "سلطة فواكه" }, price: 3.00 },
    ...
    fri: {
      soups: [
        { name: { bg: "Рибена чорба по Бургаски", en: "Burgas-Style Fish Soup", tr: "Burgas Usulü Balık Çorbası", ar: "شوربة سمك على طريقة بورغاس" }, price: 2.30 },
        { name: { bg: "Шкембе чорба", en: "Tripe Soup (Shkembe Chorba)", tr: "İşkembe Çorbası", ar: "شوربة الكرشة" }, price: 2.30 },
        { name: { bg: "Таратор", en: "Tarator (Cold Cucumber-Yogurt Soup)", tr: "Tarator (Soğuk Yoğurt Çorbası)", ar: "طاراتور (شوربة زبادي باردة)" }, price: 2.00 }
      ],
      mains: [
        ...
        { name: { bg: "3бр. Пържени кюфтета + гарн.", en: "3 pcs Fried Meatballs + Side", tr: "3 adet Kızarmış Köfte + Garnitür", ar: "3 كفتات مقلية + طبق جانبي" }, price: 4.50 },
